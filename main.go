...
func (ai *basicAI) Play(hand []deck.Card, dealer deck.Card) blackjack.Move {
	// playing strategy should be impoved to see better results
...
func (ai *basicAI) Bet(shuffled bool) int {
	...
	// Counting cards remaining in a stockpile to better the odds
	// it is not that effective if the strategy is bad
